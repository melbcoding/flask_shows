...
class User:
    ...
    # class methods for CRUD commands/query db
    @classmethod
    ...
    def get_by_id(cls,form_data):
        ...
        for row in results:
            show_data= row['show_id']
            this_user.liked_shows.append(show_data)
        return this_user
    ...
    def validate_register(user):
        ...
        if len(results)>= 1:
            flash("Email already taken, please use another!","register")
            is_valid= False
